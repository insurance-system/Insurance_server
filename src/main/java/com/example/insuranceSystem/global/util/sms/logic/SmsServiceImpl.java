package com.example.insuranceSystem.global.util.sms.logic;

import com.example.insuranceSystem.global.util.sms.web.dto.MessageDTO;
import com.example.insuranceSystem.global.util.sms.web.dto.SmsNaverReq;
...
public class SmsServiceImpl {
    ...
    public String send(SmsSendReq smsSendReq) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException, JsonProcessingException, URISyntaxException {
        ...
        messages.add(new MessageDTO(smsSendReq.getPhoneNum(), "아프시조 보험 \n 인증번호: "+certification));
